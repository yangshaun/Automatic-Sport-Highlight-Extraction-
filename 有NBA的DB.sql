...
-- 正在導出表  live.game1 的資料：~116 rows (大約)
DELETE FROM `game1`;
...
-- 正在導出表  live.game2 的資料：~145 rows (大約)
DELETE FROM `game2`;
...
-- 正在導出表  live.game3 的資料：~106 rows (大約)
DELETE FROM `game3`;
...
-- 正在導出表  live.game4 的資料：~121 rows (大約)
DELETE FROM `game4`;
...
-- 導出  表 live.mywifi 結構
CREATE TABLE IF NOT EXISTS `mywifi` (
  `SSID` varchar(50) DEFAULT NULL,
  `Level` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- 正在導出表  live.mywifi 的資料：~0 rows (大約)
DELETE FROM `mywifi`;
/*!40000 ALTER TABLE `mywifi` DISABLE KEYS */;
/*!40000 ALTER TABLE `mywifi` ENABLE KEYS */;
...
-- 正在導出表  live.nba 的資料：~128 rows (大約)
DELETE FROM `nba`;
/*!40000 ALTER TABLE `nba` DISABLE KEYS */;
INSERT INTO `nba` (`time`, `push`) VALUES
	('0830', 8),
	('0831', 7),
	('0832', 3),
	('0833', 2),
